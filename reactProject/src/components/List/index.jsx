    ...
    return (
        <>
            <div className="container container-form" >
                        ...
                        <div>
                            <table class="table">
                                <tbody>
                                    <tr>
                                        {titulos.map(item => {
                                            return <td className="me-3 mobile-text-size list-title__item text-center">{item}</td>;
                                        })}
                                    </tr>
                                    <tr>
                                        {linha1.map(item => {
                                            return <td className="me-3 mobile-text-size text-center">{item}</td>;
                                        })}
                                    </tr>
                                    <tr>
                                        {linha2.map(item => {
                ...
                <div className="btn btn-danger disabled" id="result">SEU IMC: <strong></strong></div>
            </div>
        </>  
    )
}
